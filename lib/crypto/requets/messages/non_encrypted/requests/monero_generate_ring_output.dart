...
final class NoneEncryptedRequestGenerateRingOutput
    extends NoneEncryptedCryptoRequest<MoneroRingOutput, MessageArgsOneBytes> {
  ...
  @override
  MoneroRingOutput parsResult(MessageArgsOneBytes result) {
    return MoneroRingOutput.deserialize(bytes: result.keyOne);
  }
  ...
  @override
  Future<MoneroRingOutput> result({List<int>? encryptedPart}) async {
